...
const DishesManage = () => {
  ...
  const handleAddDish = () => {
    ...
    setShowModal(false);
    setNewDish({ name: "", price: "", category: "", isValid: true, image: "" });
  };
  ...
  return (
    <div>
      ...
      <DishModal
        ...
        dishData={currentDish || newDish}
        onChange={currentDish ? handleEditChange : handleInputChange}
        onSave={currentDish ? handleEditDish : handleAddDish}
